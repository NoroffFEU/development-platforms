  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        ...
        { label: "CI/CD", collapsed: true, autogenerate: { directory: "cicd" } },
        { label: "Cloudflare", collapsed: true, autogenerate: { directory: "cloudflare" } },
        ...
        { label: "Railway", collapsed: true, autogenerate: { directory: "railway" } },
