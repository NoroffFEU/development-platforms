...
![Heroku Logo](../../../assets/heroku/logo.png)
...
- To log in to the Heroku CLI, use the heroku login command.
  ...
  ![Heroku Login](../../../assets/heroku/image1.png)
...
- In this step, you prepare a sample application that’s ready to be deployed to Heroku.
  ...
  ![Prepare the App](../../../assets/heroku/image2.png)
...
- In this step, you deploy the app to Heroku.
  ...
  ![Deploy App](../../../assets/heroku/image3.png)

  Deploy your code.

  ![Deploy your code](../../../assets/heroku/image4.png)

  Ensure that at least one instance of the app is running.

  ![App is running](../../../assets/heroku/image5.png)

  Visit the app at the URL generated by its app name. As a shortcut, you can open the website.

  ![Visit the app](../../../assets/heroku/image6.png)
