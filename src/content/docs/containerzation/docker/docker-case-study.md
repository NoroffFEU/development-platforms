...
<div style="text-align:center">
    <img src="https://pbs.twimg.com/media/FPKqqiFX0AMRBu4?format=png&name=small" alt="It works on my machine, then we will ship your machine. That is how Docker was born.">
</div>
...
## Overview of Docker Alternatives
...
## Potential Drawbacks to Consider Before Implementing Docker
