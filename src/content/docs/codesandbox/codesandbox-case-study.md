...
| Context-Aware AI assistant: Boxy (Available to all Pro subscribers) | CodeSandbox has created an AI coding companion called Boxy to make development more accessible and to increase the state of flow. Boxy can assist the user directly through the app preview and provide the user with explanations and insights, as well as generate new code for the project that is tailored to the user's specific context within CodeSandbox.                                                                                                                                    |
| Pre-configured environments                                         | The user can configure and run containers in any development environment in CodeSandbox with Dev Containers. Dev Containers allows users' to customize their own container using Dockerfile, or use existing container images to set up the development environment. With Dev Containers the user can enhance their environment by adding features on top of the container, and they can also use Docker Compose or a Dockerfile to run additional services.                                  |
...
The main use case for CodeSandbox is that it allows users' to resume any development environment within 2 seconds. CodeSandbox includes all the review tooling the user needs to accelerate the review process. Another use case for this platform is that it allows the user to start coding instantly and add as many devtools as they want for the development. CodeSandbox offers an online code editor for developers to learn and experiment with different templates, frameworks etc.
