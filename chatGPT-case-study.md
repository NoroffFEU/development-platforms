...
The model also presents limitations in terms of server capacity. It is at times unreachable due to the amount of people trying to use the service at the same time. This is being addressed by offering a subscription plan.
