...
AWS Polly is a cloud-based text-to-speech service provided by Amazon Web Services (AWS). It enables developers (and to a limited extend non-developers) to convert text into lifelike speech, supporting a wide range of languages and voices. Polly is designed to make applications more engaging by adding natural-sounding speech capabilities, useful for applications such as eLearning, accessibility, voice assistants, and more.
...
- **Engine / TTS Model**
  - Standard option - Produces robotic and stale speech. <br><br>
    Neural option - ... <br><br>
    Long-Form option - .... <br><br>
    Generative option - ... <br><br>
...
- **Voice and language Options**
  - The Standard engine offers a great variety of voice options across many languages.
  - The Neural option offers....
  - The Long-Form option offers...
  - The Generative option offers just a few voices options, and is currently limited to a few languages. These include:
