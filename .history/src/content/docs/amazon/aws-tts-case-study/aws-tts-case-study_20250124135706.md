...
- AWS_DEFAULT_REGION=replace-with-your-preferred-region

You might need to install the dotenv package for Python to load the env variables.
...
Open terminal in directory where code was saved, then run:
