...
- Install the AWS Software Development Kit for your programming language of choice. The most commonly used programming language in this area of expertise is Python, which uses the "Boto3" SDK.
