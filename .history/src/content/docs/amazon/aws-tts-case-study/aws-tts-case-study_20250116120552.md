...
- Speech parameters are adjustable across all engines, including pitch, speed, and volume.<br><br>
...
- **Voice and language Options**
  ...
  - The Generative option offers just a few voices, and is currently limited to a few languages. These include: English (most common dialects), Spanish, French, German, Italian and Hindi.
